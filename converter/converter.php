...
foreach ( $lists as $name => $list ) {
	...
	foreach ( $lines as $filter ) {
		...
		$filter = str_replace( array( '||', '^third-party', '^', '$websocket', ',websocket', ',other', '$other', '$subdocument', ',subdocument', '$important', ',important', '$object-subrequest', ',object-subrequest', '$third-party', '^third-party', ',third-party', '$image', ',image', ',script', '$script', ',object', '$object', '$popup', ',popup', '$empty', ',empty' ), '', $filter );
